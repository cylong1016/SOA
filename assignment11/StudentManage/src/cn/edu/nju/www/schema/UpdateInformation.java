...
public class UpdateInformation  implements java.io.Serializable {
    ...
    private cn.edu.nju.www.schema.个人信息类型 个人基本信息;
    ...
    public UpdateInformation(
           java.lang.String 学号,
           cn.edu.nju.www.schema.个人信息类型 个人基本信息) {
           this.学号 = 学号;
           this.个人基本信息 = 个人基本信息;
    }
     ...
     * @return 个人基本信息
     */
    public cn.edu.nju.www.schema.个人信息类型 get个人基本信息() {
        return 个人基本信息;
    }
     ...
     * @param 个人基本信息
     */
    public void set个人基本信息(cn.edu.nju.www.schema.个人信息类型 个人基本信息) {
        this.个人基本信息 = 个人基本信息;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.nju.edu.cn/schema", "updateInformation"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("学号");
        elemField.setXmlName(new javax.xml.namespace.QName("http://www.nju.edu.cn/schema", "学号"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("个人基本信息");
        elemField.setXmlName(new javax.xml.namespace.QName("http://www.nju.edu.cn/schema", "个人基本信息"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.nju.edu.cn/schema", "个人信息类型"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
