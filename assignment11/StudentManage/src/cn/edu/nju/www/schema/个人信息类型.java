...
public class 个人信息类型  implements java.io.Serializable {
    ...
    private cn.edu.nju.www.schema.性别类型 性别;

    private java.lang.String 密码;

    private java.lang.String 手机号;

    private cn.edu.nju.www.schema.院系部门类型 院系部门;
    ...
    public 个人信息类型(
           java.lang.String 姓名,
           cn.edu.nju.www.schema.性别类型 性别,
           java.lang.String 密码,
           java.lang.String 手机号,
           cn.edu.nju.www.schema.院系部门类型 院系部门) {
           this.姓名 = 姓名;
           this.性别 = 性别;
           this.密码 = 密码;
           this.手机号 = 手机号;
     ...
     * @return 性别
     */
    public cn.edu.nju.www.schema.性别类型 get性别() {
        return 性别;
    }
     ...
     * @param 性别
     */
    public void set性别(cn.edu.nju.www.schema.性别类型 性别) {
        this.性别 = 性别;
    }
     ...
     * @return 院系部门
     */
    public cn.edu.nju.www.schema.院系部门类型 get院系部门() {
        return 院系部门;
    }
     ...
     * @param 院系部门
     */
    public void set院系部门(cn.edu.nju.www.schema.院系部门类型 院系部门) {
        this.院系部门 = 院系部门;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.nju.edu.cn/schema", "个人信息类型"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("姓名");
        elemField.setXmlName(new javax.xml.namespace.QName("http://www.nju.edu.cn/schema", "姓名"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("性别");
        elemField.setXmlName(new javax.xml.namespace.QName("http://www.nju.edu.cn/schema", "性别"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.nju.edu.cn/schema", "性别类型"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("密码");
        elemField.setXmlName(new javax.xml.namespace.QName("http://www.nju.edu.cn/schema", "密码"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("手机号");
        elemField.setXmlName(new javax.xml.namespace.QName("http://www.nju.edu.cn/schema", "手机号"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("院系部门");
        elemField.setXmlName(new javax.xml.namespace.QName("http://www.nju.edu.cn/schema", "院系部门"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.nju.edu.cn/schema", "院系部门类型"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
