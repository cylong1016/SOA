			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav">
		            	<li class="active"><a href="<%=request.getContextPath() + "/jsp/student_modify.jsp" %>">查询 <span class="sr-only">(current)</span></a></li>
		            	<li><a href="<%=request.getContextPath() + "/jsp/student_modify.jsp" %>">修改信息</a></li>
			    	</ul>
