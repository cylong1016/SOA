...
public class MailLoginServiceLocator extends org.apache.axis.client.Service implements service.MailLoginService {
    ...
    public service.MailLoginPort getMailLoginPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            service.MailLoginPortBindingStub _stub = new service.MailLoginPortBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (service.MailLoginPort.class.isAssignableFrom(serviceEndpointInterface)) {
                service.MailLoginPortBindingStub _stub = new service.MailLoginPortBindingStub(new java.net.URL(MailLoginPort_address), this);
                _stub.setPortName(getMailLoginPortWSDDServiceName());
                return _stub;
            }
        }
