...
public class ScoreServiceLocator extends org.apache.axis.client.Service implements cn.edu.nju.jw.wsdl.ScoreService {
    ...
    public cn.edu.nju.jw.wsdl.ScoreInterface getScorePort() throws javax.xml.rpc.ServiceException {
    ...
    public cn.edu.nju.jw.wsdl.ScoreInterface getScorePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            cn.edu.nju.jw.wsdl.ScoreSoapBindingStub _stub = new cn.edu.nju.jw.wsdl.ScoreSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (cn.edu.nju.jw.wsdl.ScoreInterface.class.isAssignableFrom(serviceEndpointInterface)) {
                cn.edu.nju.jw.wsdl.ScoreSoapBindingStub _stub = new cn.edu.nju.jw.wsdl.ScoreSoapBindingStub(new java.net.URL(ScorePort_address), this);
                _stub.setPortName(getScorePortWSDDServiceName());
                return _stub;
            }
        }
