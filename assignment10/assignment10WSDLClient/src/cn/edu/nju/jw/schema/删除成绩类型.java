...
public class 删除成绩类型  implements java.io.Serializable {
    ...
    private cn.edu.nju.jw.schema.成绩性质类型 成绩性质;  // attribute
    ...
    public 删除成绩类型(
           ...
           cn.edu.nju.jw.schema.成绩性质类型 成绩性质) {
           this.学号 = 学号;
           this.课程编号 = 课程编号;
           this.成绩性质 = 成绩性质;
    }
     ...
     * @return 成绩性质
     */
    public cn.edu.nju.jw.schema.成绩性质类型 get成绩性质() {
        return 成绩性质;
    }
     ...
     * @param 成绩性质
     */
    public void set成绩性质(cn.edu.nju.jw.schema.成绩性质类型 成绩性质) {
        this.成绩性质 = 成绩性质;
    }
