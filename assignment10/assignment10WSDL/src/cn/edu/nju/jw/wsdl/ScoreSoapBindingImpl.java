...
public class ScoreSoapBindingImpl implements cn.edu.nju.jw.wsdl.ScoreInterface{
    public cn.edu.nju.jw.schema.单项成绩类型[] searchScore(java.lang.String studentNo) throws java.rmi.RemoteException, cn.edu.nju.jw.wsdl.SearchScoreFault {
        ...
        ArrayList< cn.edu.nju.jw.schema.单项成绩类型> list = new ArrayList< cn.edu.nju.jw.schema.单项成绩类型>();
        ...
        cn.edu.nju.jw.schema.单项成绩类型[] result = new cn.edu.nju.jw.schema.单项成绩类型[list.size()];
...
//                        	 boolean find=false;
//                        	 if(temp.getChildNodes().item(k).getNodeName().equals("tns:学号")){
//                        		if(temp.getChildNodes().item(k).getTextContent().equals(modSocre.get学号())){
//                        			 find = true;
//                        		 }
//                        	 } else if(temp.getChildNodes().item(k).getNodeName().equals("tns:得分") && find){
//                        		 temp.getChildNodes().item(k).setTextContent(modSocre.get得分()+"");
//                        		 break;
//                        	 }
//                         }
//                    }
