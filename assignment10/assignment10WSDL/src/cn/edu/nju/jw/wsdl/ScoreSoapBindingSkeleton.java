...
public class ScoreSoapBindingSkeleton implements cn.edu.nju.jw.wsdl.ScoreInterface, org.apache.axis.wsdl.Skeleton {
    ...
    */
    ...
    static {
        ...
        _oper.setReturnType(new javax.xml.namespace.QName("http://jw.nju.edu.cn/schema", "单个学生成绩列表类型"));
        ...
        _params = new org.apache.axis.description.ParameterDesc [] {
            new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("http://jw.nju.edu.cn/wsdl", "addScore"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://jw.nju.edu.cn/schema", "添加或修改成绩类型"), cn.edu.nju.jw.schema.添加或修改成绩类型.class, false, false), 
        };
        ...
        _oper.addFault(_fault);
        _params = new org.apache.axis.description.ParameterDesc [] {
            new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("http://jw.nju.edu.cn/wsdl", "delScore"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://jw.nju.edu.cn/schema", "删除成绩类型"), cn.edu.nju.jw.schema.删除成绩类型.class, false, false), 
        };
    ...
    {
        java.lang.String ret = impl.addScore(addScore);
        return ret;
    }
