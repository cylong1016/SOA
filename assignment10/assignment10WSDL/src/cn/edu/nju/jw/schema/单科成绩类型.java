...
public class 单科成绩类型  implements java.io.Serializable {
    private cn.edu.nju.jw.schema.课程 课程;
     ...
     * @return 课程
     */
    public cn.edu.nju.jw.schema.课程 get课程() {
        return 课程;
    }
     ...
     * @param 课程
     */
    public void set课程(cn.edu.nju.jw.schema.课程 课程) {
        this.课程 = 课程;
    }
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        ...
        _equals = true && 
            ...
            this.平时成绩 == other.get平时成绩() &&
            this.期末成绩 == other.get期末成绩() &&
            this.总评成绩 == other.get总评成绩();
        __equalsCalc = null;
        return _equals;
    }
    ...
    static {
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://jw.nju.edu.cn/schema", "课程"));
