...
public class 个人基本信息  implements java.io.Serializable {
    private java.lang.String 姓名;

    private java.lang.String 学号;

    private cn.edu.nju.jw.schema.单位信息 单位信息;
    ...
    public 个人基本信息(
           java.lang.String 姓名,
           java.lang.String 学号,
           cn.edu.nju.jw.schema.单位信息 单位信息) {
           this.姓名 = 姓名;
           this.学号 = 学号;
           this.单位信息 = 单位信息;
    }
    ...
    /**
     * Gets the 姓名 value for this 个人基本信息.
     * 
     * @return 姓名
     */
    ...
    /**
     * Sets the 姓名 value for this 个人基本信息.
     * 
     * @param 姓名
     */
    ...
    /**
     * Gets the 学号 value for this 个人基本信息.
     * 
     * @return 学号
     */
    ...
    /**
     * Sets the 学号 value for this 个人基本信息.
     * 
     * @param 学号
     */
    ...
    /**
     * Gets the 单位信息 value for this 个人基本信息.
     * 
     * @return 单位信息
     */
    public cn.edu.nju.jw.schema.单位信息 get单位信息() {
        return 单位信息;
    }


    /**
     * Sets the 单位信息 value for this 个人基本信息.
     * 
     * @param 单位信息
     */
    public void set单位信息(cn.edu.nju.jw.schema.单位信息 单位信息) {
        this.单位信息 = 单位信息;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof 个人基本信息)) return false;
        个人基本信息 other = (个人基本信息) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(个人基本信息.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://jw.nju.edu.cn/schema", "个人基本信息"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://jw.nju.edu.cn/schema", "单位信息"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
