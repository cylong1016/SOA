...
public class 个人成绩类型  implements java.io.Serializable {
    private cn.edu.nju.jw.schema.单科成绩类型 单科成绩;

    public 个人成绩类型() {
    }

    public 个人成绩类型(
           cn.edu.nju.jw.schema.单科成绩类型 单科成绩) {
           this.单科成绩 = 单科成绩;
    }
     ...
     * @return 单科成绩
     */
    public cn.edu.nju.jw.schema.单科成绩类型 get单科成绩() {
        return 单科成绩;
    }
     ...
     * @param 单科成绩
     */
    public void set单科成绩(cn.edu.nju.jw.schema.单科成绩类型 单科成绩) {
        this.单科成绩 = 单科成绩;
    }
