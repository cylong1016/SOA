...
public class 单位信息  implements java.io.Serializable {
    ...
    /**
     * Gets the 单位部门名 value for this 单位信息.
     * 
     * @return 单位部门名
     */
    ...
    /**
     * Sets the 单位部门名 value for this 单位信息.
     * 
     * @param 单位部门名
     */
    ...
    /**
     * Gets the 部门编号 value for this 单位信息.
     * 
     * @return 部门编号
     */
    ...
    /**
     * Sets the 部门编号 value for this 单位信息.
     * 
     * @param 部门编号
     */
    ...
    /**
     * Gets the 职务 value for this 单位信息.
     * 
     * @return 职务
     */
    ...
    /**
     * Sets the 职务 value for this 单位信息.
     * 
     * @param 职务
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof 单位信息)) return false;
        单位信息 other = (单位信息) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(单位信息.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://jw.nju.edu.cn/schema", "单位信息"));
